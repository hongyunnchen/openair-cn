...
public:
  ...
  gtpv2c_ie(const gtpv2c_tlv& t) {
    tlv = t;
  }
  gtpv2c_ie(const uint8_t tlv_type) {
    tlv = {0};
    tlv.type = tlv_type;
  }
  ...
  virtual void to_core_type(gtpv2c_ies_container& s, const uint8_t instance) {throw gtpc_msg_illegal_ie_exception(s.msg_id, tlv.type);}
...
public:
  ...
  gtpv2c_grouped_ie() : gtpv2c_ie() {
    ies = {};
  }
  gtpv2c_grouped_ie(const gtpv2c_grouped_ie& g) : gtpv2c_ie(g), ies(g.ies) {
  }

  gtpv2c_grouped_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    ies = {};
  }
  gtpv2c_grouped_ie(const uint8_t tlv_type) : gtpv2c_ie(tlv_type) {
    ies = {};
  }
...
public:
  ...
  gtpv2c_msg() : gtpv2c_msg_header() {
    ies = {};
  }
  
  gtpv2c_msg(const gtpv2c_msg& m) : gtpv2c_msg_header(m) {
    ies = m.ies;
  }

  gtpv2c_msg(const gtpv2c_msg_header& hdr) : gtpv2c_msg_header(hdr) {
    ies = {};
  }

  gtpv2c_msg(const gtpv2c_create_session_request& gtp_ies);
  gtpv2c_msg(const gtpv2c_create_session_response& gtp_ies);
  gtpv2c_msg(const gtpv2c_delete_session_request& gtp_ies);
  gtpv2c_msg(const gtpv2c_delete_session_response& gtp_ies);
  gtpv2c_msg(const gtpv2c_modify_bearer_request& gtp_ies);
  gtpv2c_msg(const gtpv2c_modify_bearer_response& gtp_ies);
  gtpv2c_msg(const gtpv2c_release_access_bearers_request& gtp_ies);
  gtpv2c_msg(const gtpv2c_release_access_bearers_response& gtp_ies);
...
//#define IMSI_BCD8_SIZE                    8                /*!< \brief  The number of digits in IMSI shall not exceed 15.       */
  ...
  //--------
  gtpv2c_imsi_ie(const core::imsi_t& i) : gtpv2c_ie(GTP_IE_IMSI) {
    // avoid using b[]
  ...
  //--------
  gtpv2c_imsi_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
...
public:
  ...
  //--------
  gtpv2c_cause_ie(const core::cause_t& i) : gtpv2c_ie(GTP_IE_CAUSE) {
  ...
  //--------
  gtpv2c_cause_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    cause_value = 0;
    u1.b = 0;
    type_of_the_offending_ie = 0;
    length_of_the_offending_ie = 0;
...
public:
  ...
  //--------
  gtpv2c_access_point_name_ie(const core::apn_t& apn) : 
gtpv2c_ie(GTP_IE_ACCESS_POINT_NAME) {
  ...
  //--------
  gtpv2c_access_point_name_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_aggregate_maximum_bit_rate_ie(const core::ambr_t& ambr) : 
gtpv2c_ie(GTP_IE_AGGREGATE_MAXIMUM_BIT_RATE) {
  ...
  //--------
  gtpv2c_aggregate_maximum_bit_rate_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    // force length
    apn_ambr_for_uplink = 0;
    apn_ambr_for_downlink = 0;
  };
  ...
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    auto nl_apn_ambr_for_uplink = htonl(apn_ambr_for_uplink);
    auto nl_apn_ambr_for_downlink = htonl(apn_ambr_for_downlink);
  ...
  void load_from(std::istream& is) {
    ...
    apn_ambr_for_uplink = ntohl(apn_ambr_for_uplink);
    apn_ambr_for_downlink = ntohl(apn_ambr_for_downlink);
  }
  //--------
  void to_core_type(gtpv2c_ies_container& s, const uint8_t instance) {
      core::ambr_t ambr = {};
...
public:
  ...
  //--------
  gtpv2c_eps_bearer_id_ie(const core::ebi_t& e) : 
gtpv2c_ie(GTP_IE_EPS_BEARER_ID){
  ...
  //--------
  gtpv2c_eps_bearer_id_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  ...
  bool is_ipv4;
  //--------
  gtpv2c_ip_address_ie(const core::ip_address_t& i) : 
gtpv2c_ie(GTP_IE_IP_ADDRESS) {
  ...
  //--------
  gtpv2c_ip_address_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.ipv6_address = in6addr_any;
    is_ipv4 = true;
  };
  //--------
...
#define IMEI_BCD8_SIZE                    8                /*!< \brief  The number of digits in IMSI shall not exceed 15.       */
  ...
  //--------
  gtpv2c_mei_ie(const core::mei_t& i) : 
gtpv2c_ie(GTP_IE_MOBILE_EQUIPMENT_IDENTITY) {
  ...
  //--------
  gtpv2c_mei_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
...
#define MSISDN_BCD8_SIZE                    8                /*!< \brief  The number of digits in IMSI shall not exceed 15.       */
  ...
  //--------
  gtpv2c_msisdn_ie(const core::msisdn_t& m) : gtpv2c_ie(GTP_IE_MSISDN) {
    // avoid using b[]
  ...
  //--------
  gtpv2c_msisdn_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
...
public:
  ...
  //--------
  gtpv2c_indication_ie(const core::indication_t& i) : 
gtpv2c_ie(GTP_IE_INDICATION) {
  ...
  //--------
  gtpv2c_indication_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    u2.b = 0;
    u3.b = 0;
    u4.b = 0;
...
public:
  ...
  protocol_or_container_id(std::istream& is): protocol_or_container_id() {
    load_from(is);
  }
  ...
  protocol_or_container_id(const protocol_or_container_id & p) {
    protocol_id = p.protocol_id;
    length_of_protocol_id_contents = p.length_of_protocol_id_contents;
    protocol_id_contents = p.protocol_id_contents;
  }
  protocol_or_container_id(const core::pco_protocol_or_container_id_t& p){
    protocol_id = p.protocol_id;
    length_of_protocol_id_contents = p.length_of_protocol_id_contents;
    protocol_id_contents = p.protocol_id_contents;
  }
...
public:
  ...
  //--------
  gtpv2c_pco_ie(const core::protocol_configuration_options_t& p) : 
gtpv2c_pco_ie(){
    tlv.length = 1;
    u1.b = 0;
    u1.bf.ext = p.ext;
  ...
  //--------
  gtpv2c_pco_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    u1.bf.ext = 1;
    num_protocol_or_container_id = 0;
    protocol_or_container_ids.reserve(PCO_UNSPEC_MAXIMUM_PROTOCOL_ID_OR_CONTAINER_ID);
...
public:
  ...
  //--------
  gtpv2c_bearer_tft_ie(const core::traffic_flow_template_t& t) : 
gtpv2c_bearer_tft_ie(){
  ...
  //--------
  gtpv2c_bearer_tft_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  //--------
  gtpv2c_bearer_context_ie(const bearer_context& b) : gtpv2c_grouped_ie(GTP_IE_BEARER_CONTEXT) {
  ...
  //--------
  gtpv2c_bearer_context_ie(const gtpv2c_tlv& t) : gtpv2c_grouped_ie(t) {
...
public:
  ...
  //--------
  gtpv2c_charging_id_ie(const core::charging_id_t& c) : 
gtpv2c_ie(GTP_IE_CHARGING_ID){
  ...
  //--------
  gtpv2c_charging_id_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    charging_id = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_bearer_flags_ie(const core::bearer_flags_t& b) : 
gtpv2c_ie(GTP_IE_CHARGING_ID){
    u1.b = 0;
    u1.bf.asi = b.asi;
    u1.bf.vind = b.vind;
  ...
  //--------
  gtpv2c_bearer_flags_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_pdn_type_ie(const core::pdn_type_t& p) : gtpv2c_ie(GTP_IE_PDN_TYPE){
  ...
  //--------
  gtpv2c_pdn_type_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  ...
  in_addr  ipv4_address; //network byte order
  //--------
  gtpv2c_paa_ie(const core::paa_t& p) : 
gtpv2c_ie(GTP_IE_PDN_ADDRESS_ALLOCATION){
  ...
  //--------
  gtpv2c_paa_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.bf.pdn_type = core::PDN_TYPE_E_NON_IP;
    ipv6_prefix_length = 0;
    ipv6_address = in6addr_any;
    ipv4_address.s_addr = INADDR_ANY;
...
public:
  ...
  //--------
  gtpv2c_bearer_qos_ie(const core::bearer_qos_t& b) : 
gtpv2c_ie(GTP_IE_BEARER_QUALITY_OF_SERVICE){
  ...
  //--------
  gtpv2c_bearer_qos_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    label_qci = 0;
    for (int i = 0; i < 5; i++) {
      maximum_bit_rate_for_uplink[i] = 0;
...
public:
  ...
  //--------
  gtpv2c_flow_qos_ie(const core::flow_qos_t& b) : 
gtpv2c_ie(GTP_IE_FLOW_QUALITY_OF_SERVICE){
  ...
  //--------
  gtpv2c_flow_qos_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    label_qci = 0;
    for (int i = 0; i < 5; i++) {
      maximum_bit_rate_for_uplink[i] = 0;
      maximum_bit_rate_for_downlink[i] = 0;
...
public:
  ...
  //--------
  gtpv2c_rat_type_ie(const core::rat_type_t& r) : gtpv2c_ie(GTP_IE_RAT_TYPE){
    rat_type = r.rat_type;
    tlv.length = 1;
  }
  //--------
  ...
  //--------
  gtpv2c_rat_type_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    rat_type = core::RAT_TYPE_E_RESERVED;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_serving_network_ie(const core::serving_network_t& s) : 
gtpv2c_ie(GTP_IE_SERVING_NETWORK){
  ...
  //--------
  gtpv2c_serving_network_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    u2.b = 0;
    u3.b = 0;
  };
...
public:
  ...
  //--------
  gtpv2c_cgi_field_ie(const core::cgi_field_t& c){
...
public:
  ...
  //--------
  gtpv2c_sai_field_ie(const core::sai_field_t& c){
    u1.bf.mcc_digit_2 = c.mcc_digit_2;
    u1.bf.mcc_digit_1 = c.mcc_digit_1;
    u2.bf.mnc_digit_3 = c.mnc_digit_3;
    u2.bf.mcc_digit_3 = c.mcc_digit_3;
...
public:
  ...
  //--------
  gtpv2c_rai_field_ie(const core::rai_field_t& c){
    u1.bf.mcc_digit_2 = c.mcc_digit_2;
    u1.bf.mcc_digit_1 = c.mcc_digit_1;
    u2.bf.mnc_digit_3 = c.mnc_digit_3;
    u2.bf.mcc_digit_3 = c.mcc_digit_3;
...
public:
  ...
  //--------
  gtpv2c_tai_field_ie(const core::tai_field_t& t){
...
public:
  ...
  //--------
  gtpv2c_ecgi_field_ie(const core::ecgi_field_t& t){
    u1.bf.mcc_digit_2 = t.mcc_digit_2;
    u1.bf.mcc_digit_1 = t.mcc_digit_1;
    u2.bf.mnc_digit_3 = t.mnc_digit_3;
    u2.bf.mcc_digit_3 = t.mcc_digit_3;
...
public:
  ...
  //--------
  gtpv2c_lai_field_ie(const core::lai_field_t& t){
    u1.bf.mcc_digit_2 = t.mcc_digit_2;
    u1.bf.mcc_digit_1 = t.mcc_digit_1;
    u2.bf.mnc_digit_3 = t.mnc_digit_3;
    u2.bf.mcc_digit_3 = t.mcc_digit_3;
...
public:
  ...
  //--------
  gtpv2c_macro_enodeb_id_field_ie(const core::macro_enodeb_id_field_t& t){
    u1.bf.mcc_digit_2 = t.mcc_digit_2;
    u1.bf.mcc_digit_1 = t.mcc_digit_1;
    u2.bf.mnc_digit_3 = t.mnc_digit_3;
    u2.bf.mcc_digit_3 = t.mcc_digit_3;
...
public:
  ...
  //--------
  gtpv2c_extended_macro_enodeb_id_field_ie(const 
...
public:
  ...
  //--------
  gtpv2c_user_location_information_ie(const core::uli_t& u) : 
gtpv2c_ie(GTP_IE_USER_LOCATION_INFORMATION){
  ...
  //--------
  gtpv2c_user_location_information_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    cgi = gtpv2c_cgi_field_ie();
    sai = gtpv2c_sai_field_ie();
    rai = gtpv2c_rai_field_ie();
...
public:
  ...
  //--------
  gtpv2c_fully_qualified_teid_ie(const core::fteid_t& f) : 
gtpv2c_ie(GTP_IE_FULLY_QUALIFIED_TUNNEL_ENDPOINT_IDENTIFIER){
  ...
  //--------
  gtpv2c_fully_qualified_teid_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    teid_gre_key = 0;
    ipv4_address.s_addr = INADDR_ANY;
    ipv6_address = in6addr_any;
...
public:
  ...
  //--------
  gtpv2c_delay_value_ie(const core::delay_value_t& d) : 
gtpv2c_ie(GTP_IE_DELAY_VALUE){
  ...
  //--------
  gtpv2c_delay_value_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    delay_value = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_ue_time_zone_ie(const core::ue_time_zone_t& t) : 
gtpv2c_ie(GTP_IE_UE_TIME_ZONE){
  ...
  //--------
  gtpv2c_ue_time_zone_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    time_zone = 0;
    u1.b = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_apn_restriction_ie(const core::access_point_name_restriction_t& a) : 
gtpv2c_ie(GTP_IE_ACCESS_POINT_NAME_RESTRICTION){
    tlv.length = 1;
    restriction_type_value = a.restriction_type_value;
  }
  //--------
  gtpv2c_apn_restriction_ie() : gtpv2c_ie(GTP_IE_ACCESS_POINT_NAME_RESTRICTION){
    tlv.length = 1;
    restriction_type_value = 0;
  }
  //--------
  gtpv2c_apn_restriction_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    restriction_type_value = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_selection_mode_ie(const core::selection_mode_t& s) : 
gtpv2c_ie(GTP_IE_SELECTION_MODE){
  ...
  //--------
  gtpv2c_selection_mode_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_fq_csid_ie(const core::fq_csid_t& f) : gtpv2c_ie(GTP_IE_FQ_CSID){
    tlv.length = 1;
    u1.b = 0;
  ...
  //--------
  gtpv2c_fq_csid_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    u1.b = 0;
    u2 = {0};
    pdn_connection_set_identifier.reserve(PDN_CONNECTION_SET_IDENTIFIER_MAX);
...
public:
  ...
  //--------
  gtpv2c_node_type_ie(const core::node_type_t& n) : gtpv2c_ie(GTP_IE_NODE_TYPE){
    tlv.length = 1;
  ...
  //--------
  gtpv2c_node_type_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    node_type = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_ran_nas_cause_ie(const core::ran_nas_cause_t& c) : 
gtpv2c_ie(GTP_IE_RAN_NAS_CAUSE){
  ...
  //--------
  gtpv2c_ran_nas_cause_ie() : gtpv2c_ie(GTP_IE_RAN_NAS_CAUSE){
    tlv.length = 1;
    u1.b = 0;
    cause_value = {};
  }
  //--------
  gtpv2c_ran_nas_cause_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
    cause_value = {};
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_ciot_optimizations_support_indication_ie(const 
...
gtpv2c_ie(GTP_IE_CIOT_OPTIMIZATIONS_SUPPORT_INDICATION){
  ...
  //--------
  gtpv2c_ciot_optimizations_support_indication_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
    u1.b = 0;
  };
  //--------
...
public:
  ...
  //--------
  gtpv2c_epco_ie(const core::extended_protocol_configuration_options_t& e) : 
gtpv2c_ie(GTP_IE_EXTENDED_PROTOCOL_CONFIGURATION_OPTIONS) {
  ...
  //--------
  gtpv2c_epco_ie(const gtpv2c_tlv& t) : gtpv2c_ie(t) {
  };
  //--------
