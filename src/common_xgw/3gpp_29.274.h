...
public:
  gtpc_msg_illegal_ie_exception(const uint8_t msg_type, const uint8_t ie_type) throw() {
    phrase = fmt::format("GTPV2-C msg {} Illegal {} Exception", msg_type, ie_type);
  }
...
#define GTP_IE_ACCESS_POINT_NAME_RESTRICTION                         (127)
