...
public:
  ...
  virtual bool get(core::imsi_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_IMSI);}
  virtual bool get(core::cause_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CAUSE);}
  // TODO GTP_IE_RECOVERY_RESTART_COUNTER
  virtual bool get(core::apn_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_ACCESS_POINT_NAME);}
  virtual bool get(core::ambr_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_AGGREGATE_MAXIMUM_BIT_RATE);}
  virtual bool get(core::ebi_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPS_BEARER_ID);}
  virtual bool get(core::ip_address_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_IP_ADDRESS);}
  virtual bool get(core::mei_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_MOBILE_EQUIPMENT_IDENTITY);}
  virtual bool get(core::msisdn_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_MSISDN);}
  virtual bool get(core::indication_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_INDICATION);}
  virtual bool get(core::protocol_configuration_options_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PROTOCOL_CONFIGURATION_OPTIONS);}
  virtual bool get(core::paa_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PDN_ADDRESS_ALLOCATION);}
  virtual bool get(core::bearer_qos_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_QUALITY_OF_SERVICE);}
  virtual bool get(core::flow_qos_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FLOW_QUALITY_OF_SERVICE);}
  virtual bool get(core::rat_type_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_RAT_TYPE);}
  virtual bool get(core::serving_network_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_SERVING_NETWORK);}
  virtual bool get(core::traffic_flow_template_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPS_BEARER_LEVEL_TRAFFIC_FLOW_TEMPLATE);}
  // TODO GTP_IE_TRAFFIC_AGGREGATE_DESCRIPTION
  virtual bool get(core::uli_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_USER_LOCATION_INFORMATION);}
  virtual bool get(core::fteid_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FULLY_QUALIFIED_TUNNEL_ENDPOINT_IDENTIFIER);}
  // TODO GTP_IE_TMSI
  // TODO GTP_IE_GLOBAL_CN_ID
  // TODO GTP_IE_S103_PDN_DATA_FORWARDING_INFO
  // TODO GTP_IE_S1U_DATA_FORWARDING_INFO
  virtual bool get(core::delay_value_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_DELAY_VALUE);}
  virtual bool get(bearer_context& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_CONTEXT);}
  virtual bool get(core::charging_id_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CHARGING_ID);}
  // TODO GTP_IE_CHARGING_CHARACTERISTICS
  // TODO  GTP_IE_TRACE_INFORMATION
  virtual bool get(core::bearer_flags_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_FLAGS);}
  virtual bool get(core::pdn_type_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PDN_TYPE);}
  virtual bool get(core::procedure_transaction_id_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PROCEDURE_TRANSACTION_ID);}
  ...
  virtual bool get(core::ue_time_zone_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_UE_TIME_ZONE);}
  ...
  virtual bool get(core::access_point_name_restriction_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_ACCESS_POINT_NAME_RESTRICTION);}
  virtual bool get(core::selection_mode_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_SELECTION_MODE);}
  // TODO
  // TODO GTP_IE_SOURCE_IDENTIFICATION
  // TODO GTP_IE_CHANGE_REPORTING_ACTION
  virtual bool get(core::fq_csid_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FQ_CSID);}
  // TODO GTP_IE_CHANNEL_NEEDED
  // TODO GTP_IE_EMLPP_PRIORITY
  virtual bool get(core::node_type_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_NODE_TYPE);}
  ...
  virtual bool get(core::uci_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_USER_CSG_INFORMATION);}
  ...
  virtual bool get(core::local_distinguished_name_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_LOCAL_DISTINGUISHED_NAME);}
  // TODO GTP_IE_NODE_FEATURES
  // TODO GTP_IE_MBMS_TIME_TO_DATA_TRANSFER
  // TODO GTP_IE_THROTTLING
  // TODO GTP_IE_ALLOCATION_RETENTION_PRIORITY
  virtual bool get(core::epc_timer_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPC_TIMER);}
  ...
  virtual bool get(core::ran_nas_cause_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_RAN_NAS_CAUSE);}
  ...
  virtual bool get(core::ciot_optimizations_support_indication_t& v, const uint8_t instance = 0) const {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CIOT_OPTIMIZATIONS_SUPPORT_INDICATION);}
  ...
  virtual void set(const core::imsi_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_IMSI);}
  virtual void set(const core::cause_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CAUSE);}
  // TODO GTP_IE_RECOVERY_RESTART_COUNTER
  virtual void set(const core::apn_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_ACCESS_POINT_NAME);}
  virtual void set(const core::ambr_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_AGGREGATE_MAXIMUM_BIT_RATE);}
  virtual void set(const core::ebi_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPS_BEARER_ID);}
  virtual void set(const core::ip_address_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_IP_ADDRESS);}
  virtual void set(const core::mei_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_MOBILE_EQUIPMENT_IDENTITY);}
  virtual void set(const core::msisdn_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_MSISDN);}
  virtual void set(const core::indication_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_INDICATION);}
  virtual void set(const core::protocol_configuration_options_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PROTOCOL_CONFIGURATION_OPTIONS);}
  virtual void set(const core::paa_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PDN_ADDRESS_ALLOCATION);}
  virtual void set(const core::bearer_qos_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_QUALITY_OF_SERVICE);}
  virtual void set(const core::flow_qos_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FLOW_QUALITY_OF_SERVICE);}
  virtual void set(const core::rat_type_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_RAT_TYPE);}
  virtual void set(const core::serving_network_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_SERVING_NETWORK);}
  virtual void set(const core::traffic_flow_template_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPS_BEARER_LEVEL_TRAFFIC_FLOW_TEMPLATE);}
  // TODO GTP_IE_TRAFFIC_AGGREGATE_DESCRIPTION
  virtual void set(const core::uli_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_USER_LOCATION_INFORMATION);}
  virtual void set(const core::fteid_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FULLY_QUALIFIED_TUNNEL_ENDPOINT_IDENTIFIER);}
  // TODO GTP_IE_TMSI
  // TODO GTP_IE_GLOBAL_CN_ID
  // TODO GTP_IE_S103_PDN_DATA_FORWARDING_INFO
  // TODO GTP_IE_S1U_DATA_FORWARDING_INFO
  virtual void set(const core::delay_value_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_DELAY_VALUE);}
  virtual void set(const bearer_context& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_CONTEXT);}
  virtual void set(const core::charging_id_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CHARGING_ID);}
  // TODO GTP_IE_CHARGING_CHARACTERISTICS
  // TODO  GTP_IE_TRACE_INFORMATION
  virtual void set(const core::bearer_flags_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_BEARER_FLAGS);}
  virtual void set(const core::pdn_type_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PDN_TYPE);}
  virtual void set(const core::procedure_transaction_id_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_PROCEDURE_TRANSACTION_ID);}
  // TODO GTP_IE_MM_CONTEXT_GSM_KEY_AND_TRIPLETS
  // TODO GTP_IE_MM_CONTEXT_UMTS_KEY_USED_CIPHER_AND_QUINTUPLETS
  // TODO GTP_IE_MM_CONTEXT_GSM_KEY_USED_CIPHER_AND_QUINTUPLETS
  // TODO GTP_IE_MM_CONTEXT_UMTS_KEY_AND_QUINTUPLETS
  ...
  // TODO GTP_IE_P_TMSI_SIGNATURE
  // TODO GTP_IE_HOP_COUNTER
  virtual void set(const core::ue_time_zone_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_UE_TIME_ZONE);}
  // TODO GTP_IE_TRACE_REFERENCE
  // TODO GTP_IE_COMPLETE_REQUEST_MESSAGE
  // TODO GTP_IE_GUTI
  // TODO GTP_IE_FULLY_QUALIFIED_CONTAINER
  ...
  // TODO GTP_IE_SOURCE_RNC_PDCP_CONTEXT_INFO
  // TODO  GTP_IE_PORT_NUMBER
  virtual void set(const core::access_point_name_restriction_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_ACCESS_POINT_NAME_RESTRICTION);}
  virtual void set(const core::selection_mode_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_SELECTION_MODE);}
  // TODO
  // TODO GTP_IE_SOURCE_IDENTIFICATION
  // TODO GTP_IE_CHANGE_REPORTING_ACTION
  virtual void set(const core::fq_csid_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_FQ_CSID);}
  // TODO GTP_IE_CHANNEL_NEEDED
  // TODO GTP_IE_EMLPP_PRIORITY
  virtual void set(const core::node_type_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_NODE_TYPE);}
  // TODO GTP_IE_FULLY_QUALIFIED_DOMAIN_NAME
  // TODO GTP_IE_TRANSACTION_IDENTIFIER
  // TODO GTP_IE_MBMS_SESSION_DURATION
  // TODO GTP_IE_MBMS_SERVICE_AREA
  ...
  // TODO GTP_IE_MBMS_DISTRIBUTION_ACKNOWLEDGE
  // TODO GTP_IE_RFSP_INDEX
  virtual void set(const core::uci_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_USER_CSG_INFORMATION);}
  // TODO GTP_IE_CSG_REPORTING_ACTION
  // TODO GTP_IE_CSG_ID
  // TODO GTP_IE_CSG_MEMBERSHIP_INDICATION
  // TODO GTP_IE_SERVICE_INDICATOR
  // TODO GTP_IE_DETACH_TYPE
  virtual void set(const core::local_distinguished_name_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_LOCAL_DISTINGUISHED_NAME);}
  // TODO GTP_IE_NODE_FEATURES
  // TODO GTP_IE_MBMS_TIME_TO_DATA_TRANSFER
  // TODO GTP_IE_THROTTLING
  // TODO GTP_IE_ALLOCATION_RETENTION_PRIORITY
  virtual void set(const core::epc_timer_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EPC_TIMER);}
  // TODO GTP_IE_SIGNALLING_PRIORITY_INDICATION
  // TODO GTP_IE_TMGI
  // TODO GTP_IE_ADDITIONAL_MM_CONTEXT_FOR_SRVCC
  // TODO GTP_IE_ADDITIONAL_FLAGS_FOR_SRVCC
  ...
  // TODO GTP_IE_ULI_TIMESTAMP
  // TODO GTP_IE_MBMS_FLAGS
  virtual void set(const core::ran_nas_cause_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_RAN_NAS_CAUSE);}
  // TODO GTP_IE_CN_OPERATOR_SELECTION_ENTITY
  // TODO GTP_IE_TRUSTED_WLAN_MODE_INDICATION
  // TODO GTP_IE_NODE_NUMBER
  // TODO GTP_IE_NODE_IDENTIFIER
  ...
  // TODO GTP_IE_REMOTE_USER_ID
  // TODO GTP_IE_REMOTE_UE_IP_INFORMATION
  virtual void set(const core::ciot_optimizations_support_indication_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_CIOT_OPTIMIZATIONS_SUPPORT_INDICATION);}
  // TODO GTP_IE_SCEF_PDN_CONNECTION
  // TODO GTP_IE_HEADER_COMPRESSION_CONFIGURATION
  virtual void set(const core::extended_protocol_configuration_options_t& v, const uint8_t instance = 0) {throw gtpc_msg_illegal_ie_exception(0, GTP_IE_EXTENDED_PROTOCOL_CONFIGURATION_OPTIONS);}
  // TODO GTP_IE_SERVING_PLMN_RATE_CONTROL
  // TODO GTP_IE_COUNTER
  // TODO GTP_IE_MAPPED_UE_USAGE_TYPE
  // TODO GTP_IE_SECONDARY_RAT_USAGE_DATA_REPORT
...
#define GTPV2C_BEARER_CONTEXT_PR_IE_EPS_BEARER_ID        ((uint64_t)1)
#define GTPV2C_BEARER_CONTEXT_PR_IE_TFT                  ((uint64_t)1 << 1)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST0          ((uint64_t)1 << 2)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST1          ((uint64_t)1 << 3)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST2          ((uint64_t)1 << 4)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST3          ((uint64_t)1 << 5)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST4          ((uint64_t)1 << 6)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST5          ((uint64_t)1 << 7)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST6          ((uint64_t)1 << 8)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST7          ((uint64_t)1 << 9)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST8          ((uint64_t)1 << 10)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST9          ((uint64_t)1 << 11)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST10         ((uint64_t)1 << 12)
#define GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST11         ((uint64_t)1 << 13)
#define GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_LEVEL_QOS     ((uint64_t)1 << 14)
#define GTPV2C_BEARER_CONTEXT_PR_IE_CAUSE                ((uint64_t)1 << 15)
#define GTPV2C_BEARER_CONTEXT_PR_IE_CHARGING_ID          ((uint64_t)1 << 16)
#define GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_FLAGS         ((uint64_t)1 << 17)
#define GTPV2C_BEARER_CONTEXT_PR_IE_PROTOCOL_CONFIGURATION_OPTIONS          ((uint64_t)1 << 18)
#define GTPV2C_BEARER_CONTEXT_PR_IE_EXTENDED_PROTOCOL_CONFIGURATION_OPTIONS ((uint64_t)1 << 19)
#define GTPV2C_BEARER_CONTEXT_PR_IE_RAN_NAS_CAUSE                           ((uint64_t)1 << 20)
  core::ebi_t                    eps_bearer_id;
  core::traffic_flow_template_t  tft;
#define BEARER_CONTEXT_MAX_FTEID_INSTANCES 12
  core::fteid_t                  fteid[BEARER_CONTEXT_MAX_FTEID_INSTANCES];
...
public:
  ...
  virtual void set(const core::ebi_t& v, const uint8_t instance = 0) {eps_bearer_id = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_EPS_BEARER_ID;}
  virtual void set(const core::traffic_flow_template_t& v, const uint8_t instance = 0) {tft = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_TFT;}
  virtual void set(const core::fteid_t& v, const uint8_t instance = 0) {
    if (instance < BEARER_CONTEXT_MAX_FTEID_INSTANCES) {
      fteid[instance] = v;
      ie_presence_mask |= (GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST0 << instance);
    } else {
      throw gtpc_tlv_bad_instance_exception(GTP_IE_BEARER_CONTEXT, instance);
    }
  }
  virtual void set(const core::bearer_qos_t& v, const uint8_t instance = 0) {bearer_level_qos = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_LEVEL_QOS;}
  virtual void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_CAUSE;}
  virtual void set(const core::charging_id_t& v, const uint8_t instance = 0) {charging_id = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_CHARGING_ID;}
  virtual void set(const core::bearer_flags_t& v, const uint8_t instance = 0) {bearer_flags = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_FLAGS;}
  virtual void set(const core::protocol_configuration_options_t& v, const uint8_t instance = 0) {pco = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_PROTOCOL_CONFIGURATION_OPTIONS;}
  virtual void set(const core::extended_protocol_configuration_options_t& v, const uint8_t instance = 0) {epco = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_EXTENDED_PROTOCOL_CONFIGURATION_OPTIONS;}
  virtual void set(const core::ran_nas_cause_t& v, const uint8_t instance = 0) {ran_nas_cause = v; ie_presence_mask |= GTPV2C_BEARER_CONTEXT_PR_IE_RAN_NAS_CAUSE;}

  virtual bool get(core::ebi_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_EPS_BEARER_ID) {v = eps_bearer_id;return true;}return false;}
  virtual bool get(core::traffic_flow_template_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_TFT) {v = tft;return true;}return false;}
  virtual bool get(core::fteid_t& v, const uint8_t instance = 0) const {if ((instance < BEARER_CONTEXT_MAX_FTEID_INSTANCES) && (ie_presence_mask & (GTPV2C_BEARER_CONTEXT_PR_IE_FTEID_INST0 << instance))) {v = fteid[instance];return true;}return false;}
  virtual bool get(core::bearer_qos_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_LEVEL_QOS) {v = bearer_level_qos;return true;}return false;}
  virtual bool get(core::cause_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_CAUSE) {v = cause;return true;}return false;}
  virtual bool get(core::charging_id_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_CHARGING_ID) {v = charging_id;return true;}return false;}
  virtual bool get(core::bearer_flags_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_BEARER_FLAGS) {v = bearer_flags;return true;}return false;}
  virtual bool get(core::protocol_configuration_options_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_PROTOCOL_CONFIGURATION_OPTIONS) {v = pco;return true;}return false;}
  virtual bool get(core::extended_protocol_configuration_options_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_EXTENDED_PROTOCOL_CONFIGURATION_OPTIONS) {v = epco;return true;}return false;}
  virtual bool get(core::ran_nas_cause_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_BEARER_CONTEXT_PR_IE_RAN_NAS_CAUSE) {v = ran_nas_cause;return true;}return false;}
};
...
#define GTPV2C_BEARER_CONTEXT_TO_BE_CREATED_WITHIN_CREATE_SESSION_REQUEST_PR_IE_S11_U_MME_FTEID      ((uint64_t)1 << 10)
  ...
  bearer_context_to_be_created_within_create_session_request(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
#define GTPV2C_BEARER_CONTEXT_TO_BE_REMOVED_WITHIN_CREATE_SESSION_REQUEST_PR_IE_S4_U_SGSN_FTEID      ((uint64_t)1 << 1)
  ...
  bearer_context_to_be_removed_within_create_session_request(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
#define GTPV2C_CREATE_SESSION_REQUEST_PR_IE_MAXIMUM_APN_RESTRICTION             ((uint64_t)1 << 13)
...
#define GTPV2C_CREATE_SESSION_REQUEST_PR_IE_PRIVATE_EXTENSION                   ((uint64_t)1 << 61)
  ...
  core::apn_restriction_t maximum_apn_restriction; ///< This IE shall be included on the S4/S11 and S5/S8
  ...
  gtpv2c_create_session_request(const gtpv2c_create_session_request& i) {
    ...
    pdn_type = i.pdn_type;
    paa = i.paa;
    maximum_apn_restriction = i.maximum_apn_restriction;
    ambr = i.ambr;
  ...
  const char* get_msg_name() const {return "CREATE_SESSION_REQUEST";};
  ...
  bool get(core::apn_restriction_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_REQUEST_PR_IE_MAXIMUM_APN_RESTRICTION) {v = maximum_apn_restriction;return true;}return false;}
  ...
  bool has_bearer_context_to_be_created() {if (ie_presence_mask & GTPV2C_CREATE_SESSION_REQUEST_PR_IE_BEARER_CONTEXTS_TO_BE_CREATED) return true; else return false;}
  bool has_bearer_context_to_be_removed() {if (ie_presence_mask & GTPV2C_CREATE_SESSION_REQUEST_PR_IE_BEARER_CONTEXTS_TO_BE_REMOVED) return true; else return false;}
  ...
  void set(const core::apn_restriction_t& v, const uint8_t instance = 0) {maximum_apn_restriction = v; ie_presence_mask |= GTPV2C_CREATE_SESSION_REQUEST_PR_IE_MAXIMUM_APN_RESTRICTION;}
...
#define GTPV2C_BEARER_CONTEXT_CREATED_WITHIN_CREATE_SESSION_RESPONSE_PR_IE_S11_U_SGW_FTEID        ((uint64_t)1 << 11)
  ...
  bearer_context_created_within_create_session_response(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
#define GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_CREATE_SESSION_RESPONSE_PR_IE_CAUSE         ((uint64_t)1 << 1)
  ...
  bearer_context_marked_for_removal_within_create_session_response(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  uint64_t           ie_presence_mask;
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CAUSE                              ((uint64_t)1)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CHANGE_REPORTING_ACTION            ((uint64_t)1 << 1)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CSG_INFORMATION_REPORTING_ACTION   ((uint64_t)1 << 2)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_HENB_INFORMATION_REPORTING         ((uint64_t)1 << 3)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SENDER_FTEID_FOR_CONTROL_PLANE     ((uint64_t)1 << 4)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_S5S8_FTEID_FOR_CONTROL_PLANE   ((uint64_t)1 << 5)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PAA                                ((uint64_t)1 << 6)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_RESTRICTION                    ((uint64_t)1 << 7)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_AMBR                           ((uint64_t)1 << 8)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_LINKED_EPS_BEARER_ID               ((uint64_t)1 << 9)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PCO                                ((uint64_t)1 << 10)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_CREATED            ((uint64_t)1 << 11)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_MARKED_FOR_REMOVAL ((uint64_t)1 << 12)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_RECOVERY                           ((uint64_t)1 << 13)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CHARGING_GATEWAY_NAME              ((uint64_t)1 << 14)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CHARGING_GATEWAY_ADDRESS           ((uint64_t)1 << 15)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_FQ_CSID                        ((uint64_t)1 << 16)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_FQ_CSID                        ((uint64_t)1 << 17)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_LDN                            ((uint64_t)1 << 18)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_LDN                            ((uint64_t)1 << 19)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_BACK_OFF_TIME                  ((uint64_t)1 << 20)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APCO                               ((uint64_t)1 << 21)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_TRUSTED_WLAN_IPV4_PARAMETERS       ((uint64_t)1 << 22)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_INDICATION_FLAGS                   ((uint64_t)1 << 23)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PRESENCE_REPORTING_AREA_ACTION     ((uint64_t)1 << 24)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_NODE_LEVEL_LOAD_CONTROL_INFORMATION ((uint64_t)1 << 25)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_APN_LEVEL_LOAD_CONTROL_INFORMATION  ((uint64_t)1 << 26)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_NODE_LEVEL_LOAD_CONTROL_INFORMATION ((uint64_t)1 << 27)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_OVERLOAD_CONTROL_INFORMATION   ((uint64_t)1 << 28)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_OVERLOAD_CONTROL_INFORMATION   ((uint64_t)1 << 29)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_NBIFOM_CONTAINER                   ((uint64_t)1 << 30)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PDN_CONNECTION_CHARGING_ID         ((uint64_t)1 << 31)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_EPCO                               ((uint64_t)1 << 32)
#define GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PRIVATE_EXTENSION                  ((uint64_t)1 << 33)

  // here fields listed in 3GPP TS 29.274
  core::cause_t            cause;               ///< If the SGW cannot accept any of the "Bearer Context Created" IEs within Create Session Request
  ...
  core::fteid_t                  sender_fteid_for_cp;        ///< Sender F-TEID for control plane
  ...
  core::fteid_t                  s5_s8_pgw_fteid;      ///< PGW S5/S8/S2b F-TEID for PMIP based interface or for GTP based Control Plane interface
  ...
  core::access_point_name_restriction_t         apn_restriction;     ///< This IE shall be included on the S5/S8 and S4/S11
  ///< interfaces in the E-UTRAN initial attach, PDP Context
  ///< Activation and UE Requested PDN connectivity
  ///< procedures.
  ...
  core::ambr_t             apn_ambr;                  ///< Aggregate Maximum Bit Rate (APN-AMBR)
  ///< This IE represents the APN-AMBR. It shall be included on
  ///< the S5/S8, S4/S11 and S2b interfaces if the received APN-
  ///< AMBR has been modified by the PCRF.

  core::ebi_t              linked_eps_bearer_id;                ///< This IE shall be sent on the S4/S11 interfaces during
  ...
  std::vector<bearer_context_created_within_create_session_response> bearer_contexts_created;///< EPS bearers corresponding to Bearer Contexts sent in
  ...
  std::vector<bearer_context_marked_for_removal_within_create_session_response> bearer_contexts_marked_for_removal; ///< EPS bearers corresponding to Bearer Contexts to be
  ...
  core::fq_csid_t                pgw_fq_csid;         ///< This IE shall be included by the PGW on the S5/S8 and
  ...
  core::fq_csid_t                sgw_fq_csid;         ///< This IE shall be included by the SGW on the S11 interface
  ///< according to the requirements in 3GPP TS 23.007 [17].

  core::local_distinguished_name_t sgw_ldn;     ///< This IE is optionally sent by the SGW to the MME/SGSN
  ...
  core::local_distinguished_name_t pgw_ldn;     ///< This IE is optionally included by the PGW on the S5/S8
  ...
  core::epc_timer_t pgw_back_off_time;                ///< This IE may be included on the S5/S8 and S4/S11
  ...
  const char* get_msg_name() const {return "CREATE_SESSION_RESPONSE";};

  bool get(core::cause_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CAUSE) {v = cause;return true;}return false;}
  bool get_sender_fteid_for_cp(core::fteid_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SENDER_FTEID_FOR_CONTROL_PLANE) {v = sender_fteid_for_cp;return true;}return false;}
  bool get_s5_s8_pgw_fteid(core::fteid_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_S5S8_FTEID_FOR_CONTROL_PLANE) {v = s5_s8_pgw_fteid;return true;}return false;}
  bool get(core::paa_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PAA) {v = paa;return true;}return false;}
  bool get(core::apn_restriction_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_RESTRICTION) {v = apn_restriction;return true;}return false;}
  bool get(core::ambr_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_AMBR) {v = apn_ambr;return true;}return false;}
  bool get(core::ebi_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_LINKED_EPS_BEARER_ID) {v = linked_eps_bearer_id;return true;}return false;}
  bool get(core::protocol_configuration_options_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PCO) {v = pco;return true;}return false;}
  bool get_pgw_fq_csid(core::fq_csid_t& v) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_FQ_CSID) {v = pgw_fq_csid;return true;}return false;}
  bool get_sgw_fq_csid(core::fq_csid_t& v) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_FQ_CSID) {v = sgw_fq_csid;return true;}return false;}
  bool get_sgw_ldn(core::local_distinguished_name_t& v) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_LDN) {v = sgw_ldn;return true;}return false;}
  bool get_pgw_ldn(core::local_distinguished_name_t& v) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_LDN) {v = pgw_ldn;return true;}return false;}
  bool get(core::epc_timer_t& v) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_BACK_OFF_TIME) {v = pgw_back_off_time;return true;}return false;}
  bool get(core::indication_t& v, const uint8_t instance = 0) const {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_INDICATION_FLAGS) {v = indication_flags;return true;}return false;}
  ...
  bool has_bearer_context_created() {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_CREATED) return true; else return false;}
  bool has_bearer_context_marked_for_removal() {if (ie_presence_mask & GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_MARKED_FOR_REMOVAL) return true; else return false;}

  void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_CAUSE;};
  void set_sender_fteid_for_cp(const core::fteid_t& v) {sender_fteid_for_cp = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SENDER_FTEID_FOR_CONTROL_PLANE;}
  void set_s5_s8_pgw_fteid(const core::fteid_t& v) {s5_s8_pgw_fteid = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_S5S8_FTEID_FOR_CONTROL_PLANE;}
  void set(const core::paa_t& v, const uint8_t instance = 0) {paa = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PAA;}
  void set(const core::apn_restriction_t& v, const uint8_t instance = 0) {apn_restriction = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_RESTRICTION;}
  void set(const core::ambr_t& v, const uint8_t instance = 0) {apn_ambr = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_APN_AMBR;}
  void set(const core::ebi_t& v, const uint8_t instance = 0) {linked_eps_bearer_id = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_LINKED_EPS_BEARER_ID;}
  void set(const core::protocol_configuration_options_t& v, const uint8_t instance = 0) {pco = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PCO;}
  void add_bearer_context_created(const bearer_context_created_within_create_session_response& v) {
    bearer_contexts_created.push_back(v);
    ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_CREATED;
  }
  void add_bearer_context_marked_for_removal(const bearer_context_marked_for_removal_within_create_session_response& v) {
    bearer_contexts_marked_for_removal.push_back(v);
    ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_BEARER_CONTEXTS_MARKED_FOR_REMOVAL;
  }
  void set_pgw_fq_csid(const core::fq_csid_t& v) {pgw_fq_csid = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_FQ_CSID;}
  void set_sgw_fq_csid(const core::fq_csid_t& v) {sgw_fq_csid = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_FQ_CSID;}
  void set_sgw_ldn(const core::local_distinguished_name_t& v) {sgw_ldn = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_SGW_LDN;}
  void set_pgw_ldn(const core::local_distinguished_name_t& v) {pgw_ldn = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_LDN;}
  void set(const core::epc_timer_t& v, const uint8_t instance = 0) {pgw_back_off_time = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_PGW_BACK_OFF_TIME;}
  void set(const core::indication_t& v, const uint8_t instance = 0) {indication_flags = v;ie_presence_mask |= GTPV2C_CREATE_SESSION_RESPONSE_PR_IE_INDICATION_FLAGS;}
  void set(const core::fteid_t& v, const uint8_t instance = 0) {
    switch (instance) {
    case 0: set_sender_fteid_for_cp(v); break;
...
#define GTPV2C_BEARER_CONTEXT_TO_BE_CREATED_WITHIN_CREATE_BEARER_REQUEST_PR_IE_EPCO                 ((uint64_t)1 << 13)
  ...
  bearer_context_to_be_created_within_create_bearer_request(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  const char* get_msg_name() const {return "CREATE_BEARER_REQUEST";};
...
#define GTPV2C_BEARER_CONTEXT_WITHIN_CREATE_BEARER_RESPONSE_PR_IE_EPCO                   ((uint64_t)1 << 16)
  ...
  bearer_context_within_create_bearer_response(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  const char* get_msg_name() const {return "CREATE_BEARER_RESPONSE";};
...
#define GTPV2C_BEARER_CONTEXT_TO_BE_MODIFIED_WITHIN_MODIFY_BEARER_REQUEST_PR_IE_S11_U_MME_FTEID      ((uint64_t)1 << 5)
  ...
  bearer_context_to_be_modified_within_modify_bearer_request(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
#define GTPV2C_BEARER_CONTEXT_TO_BE_REMOVED_WITHIN_MODIFY_BEARER_REQUEST_PR_IE_EPS_BEARER_ID        ((uint64_t)1)
  ...
  bearer_context_to_be_removed_within_modify_bearer_request(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  const char* get_msg_name() const {return "MODIFY_BEARER_REQUEST";};
...
#define GTPV2C_MODIFY_BEARER_REQUEST_PR_IE_PRIVATE_EXTENSION                   ((uint64_t)1 << 34)
  ...
  bool has_bearer_context_to_be_modified() {if (ie_presence_mask & GTPV2C_MODIFY_BEARER_REQUEST_PR_IE_BEARER_CONTEXTS_TO_BE_MODIFIED) return true; else return false;}
  bool has_bearer_context_to_be_removed() {if (ie_presence_mask & GTPV2C_MODIFY_BEARER_REQUEST_PR_IE_BEARER_CONTEXTS_TO_BE_REMOVED) return true; else return false;}
...
public:
  uint32_t           ie_presence_mask;
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID        ((uint64_t)1)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE                ((uint64_t)1 << 1)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S1_U_SGW_FTEID       ((uint64_t)1 << 2)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S12_SGW_FTEID        ((uint64_t)1 << 3)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S4_U_SGW_FTEID       ((uint64_t)1 << 4)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CHARGING_ID          ((uint64_t)1 << 5)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_FLAGS         ((uint64_t)1 << 6)
#define GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S11_U_SGW_FTEID      ((uint64_t)1 << 7)
  core::ebi_t                    eps_bearer_id;
  core::cause_t                  cause;
  core::fteid_t                  s1_u_sgw_fteid;
  core::fteid_t                  s12_sgw_fteid;
  ...
  void set(const core::ebi_t& v, const uint8_t instance = 0) {eps_bearer_id = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID;}
  void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE;}
  void set_s1_u_sgw_fteid(const core::fteid_t& v) {s1_u_sgw_fteid = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S1_U_SGW_FTEID;}
  void set_s12_sgw_fteid(const core::fteid_t& v) {s12_sgw_fteid = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S12_SGW_FTEID;}
  void set_s4_u_sgw_fteid(const core::fteid_t& v) {s4_u_sgw_fteid = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S4_U_SGW_FTEID;}
  void set(const core::charging_id_t& v, const uint8_t instance = 0) {charging_id = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CHARGING_ID;}
  void set(const core::bearer_flags_t& v, const uint8_t instance = 0) {bearer_flags = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_FLAGS;}
  void set_s11_u_sgw_fteid(const core::fteid_t& v) {s11_u_sgw_fteid = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S11_U_SGW_FTEID;}
  ...
  bearer_context_modified_within_modify_bearer_response(const bearer_context& b)
  {
    ie_presence_mask = 0;
    if (b.get(eps_bearer_id, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID;
    if (b.get(cause, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE;
    if (b.get(s1_u_sgw_fteid, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S1_U_SGW_FTEID;
    if (b.get(s12_sgw_fteid, 1)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S12_SGW_FTEID;
    if (b.get(s4_u_sgw_fteid, 2)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S4_U_SGW_FTEID;
    if (b.get(charging_id, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CHARGING_ID;
    if (b.get(bearer_flags, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_FLAGS;
    if (b.get(s11_u_sgw_fteid, 3)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MODIFIED_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_S11_U_SGW_FTEID;
  }
};

class bearer_contexts_marked_for_removal_within_modify_bearer_response {
public:
  uint32_t           ie_presence_mask;
#define GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID        ((uint64_t)1)
#define GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE                ((uint64_t)1 << 1)
  core::ebi_t                    eps_bearer_id;
  core::cause_t                  cause;

  void set(const core::ebi_t& v, const uint8_t instance = 0) {eps_bearer_id = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID;}
  void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v;ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE;}
  bearer_contexts_marked_for_removal_within_modify_bearer_response()
  {
    ie_presence_mask = 0;
    eps_bearer_id = {};
    cause = {};
  ...
  bearer_contexts_marked_for_removal_within_modify_bearer_response(const bearer_context& b)
  {
    ie_presence_mask = 0;
    if (b.get(eps_bearer_id, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_EPS_BEARER_ID;
    if (b.get(cause, 0)) ie_presence_mask |= GTPV2C_BEARER_CONTEXT_MARKED_FOR_REMOVAL_WITHIN_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE;
  }
};
...
public:
  ...
  const char* get_msg_name() const {return "MODIFY_BEARER_RESPONSE";};

  static const uint8_t msg_id = GTP_MODIFY_BEARER_RESPONSE;
  uint64_t           ie_presence_mask;
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE                              ((uint64_t)1)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_MSISDN                             ((uint64_t)1 << 1)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_LINKED_EPS_BEARER_ID               ((uint64_t)1 << 2)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_APN_RESTRICTION                    ((uint64_t)1 << 3)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PCO                                ((uint64_t)1 << 4)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_CONTEXTS_MODIFIED           ((uint64_t)1 << 5)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_CONTEXTS_MARKED_FOR_REMOVAL ((uint64_t)1 << 6)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CHANGE_REPORTING_ACTION            ((uint64_t)1 << 7)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CSG_INFORMATION_REPORTING_ACTION   ((uint64_t)1 << 8)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CHARGING_GATEWAY_NAME              ((uint64_t)1 << 9)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CHARGING_GATEWAY_ADDRESS           ((uint64_t)1 << 10)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_FQ_CSID                        ((uint64_t)1 << 11)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_SGW_FQ_CSID                        ((uint64_t)1 << 12)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_RECOVERY                           ((uint64_t)1 << 13)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_SGW_LDN                            ((uint64_t)1 << 14)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_LDN                            ((uint64_t)1 << 15)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_INDICATION_FLAGS                   ((uint64_t)1 << 16)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PRESENCE_REPORTING_AREA_ACTION     ((uint64_t)1 << 17)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_NODE_LEVEL_LOAD_CONTROL_INFORMATION ((uint64_t)1 << 18)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_APN_LEVEL_LOAD_CONTROL_INFORMATION  ((uint64_t)1 << 19)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_SGW_NODE_LEVEL_LOAD_CONTROL_INFORMATION ((uint64_t)1 << 20)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_OVERLOAD_CONTROL_INFORMATION   ((uint64_t)1 << 21)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_SGW_OVERLOAD_CONTROL_INFORMATION   ((uint64_t)1 << 22)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PDN_CONNECTION_CHARGING_ID         ((uint64_t)1 << 23)
#define GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PRIVATE_EXTENSION                  ((uint64_t)1 << 24)

  // here fields listed in 3GPP TS 29.274
  core::cause_t            cause;               ///<
  core::msisdn_t           msisdn;
  core::ebi_t                    linked_eps_bearer_id;///< This IE shall be sent on S5/S8 when the UE moves from a
  ...
  core::access_point_name_restriction_t         apn_restriction;     ///< This IE denotes the restriction on the combination of types
  ///< of APN for the APN associated with this EPS bearer
  ...
  core::protocol_configuration_options_t         pco; ///< If SGW receives this IE from PGW on GTP or PMIP based
  ...
  std::vector<bearer_context_modified_within_modify_bearer_response> bearer_contexts_modified;///< EPS bearers corresponding to Bearer Contexts to be
  ...
  std::vector<bearer_contexts_marked_for_removal_within_modify_bearer_response> bearer_contexts_marked_for_removal; ///< EPS bearers corresponding to Bearer Contexts to be
  ...
  core::fq_csid_t                pgw_fq_csid;         ///< This IE shall be included by PGW on S5/S8and shall be
  ///< forwarded by SGW on S11 according to the requirements
  ///< in 3GPP TS 23.007 [17].

  core::fq_csid_t                sgw_fq_csid;         ///< This IE shall be included by SGW on S11 according to the
  ///< requirements in 3GPP TS 23.007 [17].
  ...
  // SGW's Overload Control Information
  core::charging_id_t              pdn_connection_charging_id;
  // Private Extension Private Extension        ///< optional

  void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_CAUSE;}
  void set(const core::msisdn_t& v, const uint8_t instance = 0) {msisdn = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_MSISDN;}
  void set(const core::ebi_t& v, const uint8_t instance = 0) {linked_eps_bearer_id = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_LINKED_EPS_BEARER_ID;}
  void set(const core::access_point_name_restriction_t& v, const uint8_t instance = 0) {apn_restriction = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_APN_RESTRICTION;}
  void set(const core::protocol_configuration_options_t& v, const uint8_t instance = 0) {pco = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PCO;}
  void add_bearer_context_modified(const bearer_context_modified_within_modify_bearer_response& v) {bearer_contexts_modified.push_back(v);ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_CONTEXTS_MODIFIED;}
  void add_bearer_context_marked_for_removal(const bearer_contexts_marked_for_removal_within_modify_bearer_response& v) {bearer_contexts_marked_for_removal.push_back(v);ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_BEARER_CONTEXTS_MARKED_FOR_REMOVAL;}
  void set_pgw_fq_csid(const core::fq_csid_t& v) {pgw_fq_csid = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PGW_FQ_CSID;}
  void set_sgw_fq_csid(const core::fq_csid_t& v) {sgw_fq_csid = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_SGW_FQ_CSID;}
  void set(const core::indication_t& v, const uint8_t instance = 0) {indication_flags = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_INDICATION_FLAGS;}
  void set(const core::charging_id_t& v, const uint8_t instance = 0) {pdn_connection_charging_id = v;ie_presence_mask |= GTPV2C_MODIFY_BEARER_RESPONSE_PR_IE_PDN_CONNECTION_CHARGING_ID;}
  void set(const bearer_context& v, const uint8_t instance = 0) {
    switch (instance) {
    case 0: {
      ...
      break;
    case 1: {
        bearer_contexts_marked_for_removal_within_modify_bearer_response b(v);
        add_bearer_context_marked_for_removal(b);
      }
      break;
    default:
...
public:
  ...
  const char* get_msg_name() const {return "DELETE_SESSION_REQUEST";};
...
public:
  ...
  const char* get_msg_name() const {return "DELETE_SESSION_RESPONSE";};
...
public:
  ...
  const char* get_msg_name() const {return "RELEASE_ACCESS_BEARERS_REQUEST";};

#define GTPV2C_RELEASE_ACCESS_BEARERS_REQUEST_PR_IE_LIST_OF_RABS               ((uint64_t)1)
#define GTPV2C_RELEASE_ACCESS_BEARERS_REQUEST_PR_IE_ORIGINATING_NODE           ((uint64_t)1 << 1)
#define GTPV2C_RELEASE_ACCESS_BEARERS_REQUEST_PR_IE_INDICATION_FLAGS           ((uint64_t)1 << 2)
#define GTPV2C_RELEASE_ACCESS_BEARERS_REQUEST_PR_IE_PRIVATE_EXTENSION          ((uint64_t)1 << 3)
  ...
  core::node_type_t               originating_node;        ///< This IE shall be sent on S11 interface, if ISR is active in the MME.
                                                     ///< This IE shall be sent on S4 interface, if ISR is active in the SGSN
  core::indication_t        indication_flags;
  // Secondary RAT Usage Data Report
  // Private Extension Private Extension ///< optional
  void set(const core::node_type_t& v, const uint8_t instance = 0) {originating_node = v;ie_presence_mask |= GTPV2C_RELEASE_ACCESS_BEARERS_REQUEST_PR_IE_ORIGINATING_NODE;}
  void set(const core::indication_t& v, const uint8_t instance = 0) {indication_flags = v;ie_presence_mask |= GTPV2C_DELETE_SESSION_RESPONSE_PR_IE_INDICATION_FLAGS;}
};
...
public:
  ...
  const char* get_msg_name() const {return "RELEASE_ACCESS_BEARERS_RESPONSE";};

#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_CAUSE                      ((uint64_t)1)
#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_RECOVERY                   ((uint64_t)1 << 1)
#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_INDICATION_FLAGS           ((uint64_t)1 << 2)
#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_SGW_NODE_LEVEL_LOAD_CONTROL_INFORMATION ((uint64_t)1 << 3)
#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_SGW_OVERLOAD_CONTROL_INFORMATION ((uint64_t)1 << 4)
#define GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_PRIVATE_EXTENSION          ((uint64_t)1 << 5)
  static const uint8_t msg_id = GTP_RELEASE_ACCESS_BEARERS_RESPONSE;
  uint64_t                  ie_presence_mask;
  ...
  void set(const core::cause_t& v, const uint8_t instance = 0) {cause = v;ie_presence_mask |= GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_CAUSE;}
  void set(const core::indication_t& v, const uint8_t instance = 0) {indication_flags = v;ie_presence_mask |= GTPV2C_RELEASE_ACCESS_BEARERS_RESPONSE_PR_IE_INDICATION_FLAGS;}
};
...
#define GTPV2C_BEARER_CONTEXT_WITHIN_DELETE_BEARER_COMMAND_PR_IE_RAN_NAS_RELEASE_CAUSE ((uint64_t)1 << 2)
  ...
  bearer_context_within_delete_bearer_command(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  const char* get_msg_name() const {return "DELETE_BEARER_COMMAND";};
...
#define GTPV2C_BEARER_CONTEXT_WITHIN_DELETE_BEARER_FAILURE_INDICATION_PR_IE_CAUSE                 ((uint64_t)1 << 1)
  ...
  bearer_context_within_delete_bearer_failure_indication(const bearer_context& b)
  {
    ie_presence_mask = 0;
...
public:
  ...
  gtpv2c_delete_bearer_failure_indication(const gtpv2c_delete_bearer_failure_indication& i) {
    ie_presence_mask = i.ie_presence_mask;
    cause = i.cause;
    indication_flags = i.indication_flags;
  }
  const char* get_msg_name() const {return "DELETE_BEARER_FAILURE_INDICATION";};
...
public:
  ...
  const char* get_msg_name() const {return "DOWNLINK_DATA_NOTIFICATION";};
...
public:
  ...
  const char* get_msg_name() const {return "DOWNLINK_DATA_NOTIFICATION_ACKNOWLEDGE";};
...
public:
  ...
  const char* get_msg_name() const {return "DOWNLINK_DATA_NOTIFICATION_FAILURE_INDICATION";};
