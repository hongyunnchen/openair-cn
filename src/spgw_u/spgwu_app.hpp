...
//  boost::atomic<teid_t>                 teid_sxa_cp;
...
//  void handle_itti_msg (itti::itti_sxa_heartbeat_request& m);
//  void handle_itti_msg (itti::itti_sxa_heartbeat_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_pfd_management_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_pfd_management_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_setup_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_setup_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_update_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_update_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_release_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_association_release_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_version_not_supported_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_node_report_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_node_report_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_establishment_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_establishment_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_modification_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_modification_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_deletion_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_deletion_response& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_report_request& m);
//  void handle_itti_msg (itti::itti_sxa_pfcp_session_report_response& m);
};
}
