...
public:
  ...
  //shared_ptr<sebc_procedure> find_procedure(sebc_procedure* proc);
  ...
  void handle_itti_msg (core::itti::itti_s5s8_create_session_request& csreq);
  ...
  //--------------------------------------------
  // internals
  //vector<shared_ptr<sebc_procedure>> pending_procedures;
};
}
