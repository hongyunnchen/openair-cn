...
public:
  ...
  std::shared_ptr<sgw_eps_bearer> get_eps_bearer(const core::ebi_t& ebi);
...
public:
  ...
  void create_procedure(core::itti::itti_s11_create_session_request& csreq);
  void create_procedure(core::itti::itti_s11_modify_bearer_request& csreq);
  void create_procedure(core::itti::itti_s11_delete_session_request& dsreq);
  ...
  std::shared_ptr<sgw_pdn_connection> find_pdn_connection(const std::string apn, const core::pdn_type_t pdn_type);
  std::shared_ptr<sgw_pdn_connection> find_pdn_connection(const core::ebi_t& ebi);
